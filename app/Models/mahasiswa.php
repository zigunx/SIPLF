...
class mahasiswa extends Model {
    ...
    protected $fillable = array('nama_mahasiswa', 'id_registrasi', 'id_jurusan','tmp_tgl_lahir','jenkel','agama','ukuran_jas','s_kerja','s_nikah','alamat','no_hp','nama_ortu','nama_suis','pendidikan_terakhir','alamat_skolah','persyaratan');
